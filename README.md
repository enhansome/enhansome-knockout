...
* [Kendo](https://github.com/kendo-labs/knockout-kendo) ⚠️ Archived - A project to create a robust set of Knockout.js bindings for the Kendo UI widgets
* Jquery[UI](https://github.com/madcapnmckay/Knockout-UI) ⭐ 261 | 🐛 5 | 🌐 JavaScript | 📅 2013-06-09 - Rich UI components based on KnockoutJS
* [Bootstrap](https://github.com/billpull/knockout-bootstrap) ⭐ 232 | 🐛 31 | 🌐 JavaScript | 📅 2018-05-23 - A plugin that adds custom bindings for twitter bootstrap objects such as tooltips and popovers
* [ASP.NET MVC](https://github.com/AndreyAkinshin/knockout-mvc) ⚠️ Archived - Power of Knockout.js for ASP.NET MVC
* [Rails](https://github.com/dnagir/knockout-rails) ⚠️ Archived - KnockoutJS for Rails
* [Meteor](https://github.com/steveluscher/knockout.meteor) ⭐ 65 | 🐛 2 | 🌐 JavaScript | 📅 2013-07-04 - A Knockout-to-Meteor bridge

## Plugins and libraries

* [Validation](https://github.com/Knockout-Contrib/Knockout-Validation) ⭐ 1,010 | 🐛 136 | 🌐 JavaScript | 📅 2022-07-27 - A validation library for Knockout JS
...
* [Cart](https://github.com/robconery/knockout-cart) ⭐ 84 | 🐛 0 | 🌐 JavaScript | 📅 2013-03-27 - Simple browser-based shopping cart that uses local storage
* [Testing](https://github.com/profiscience/ko-component-tester) ⭐ 15 | 🐛 3 | 🌐 JavaScript | 📅 2019-02-13 - Helpful utilities for TDD + Knockout.js

## Examples

* [WebSockets](https://github.com/carlhoerberg/knockout-websocket-example) ⭐ 91 | 🐛 0 | 🌐 JavaScript | 📅 2010-10-20 - Example of real time collaborative web app using WebSockets and Knockout
